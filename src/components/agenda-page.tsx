      ...
      <div className="overflow-x-auto"><table className="w-full min-w-[950px] text-left text-sm">
        ...
        <tbody className="divide-y">{items.map((item) => {
          ...
          return <tr key={item.id}>
            ...
            {canManageFinance && <td className="p-3"><ModalShell title="Registrar pagamento" variant="payment"><AppointmentPaymentForm appointmentId={item.id} client={item.client} description={item.service} defaultAmount={price} /></ModalShell></td>}
