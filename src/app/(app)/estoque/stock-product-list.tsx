...
export type StockProductRow = {
  ...
  consumptionQuantityLabel: string;
  costUnit: string;
  costTotal: string;
  consumptionCostTotal: string;
  saleUnit: string;
  saleTotal: string;
  consumptionSaleTotal: string;
  minimum: number;
        ...
        >
          <div className="panel mx-auto my-6 w-full max-w-3xl">
            <div className="flex justify-between">
              <h2 className="text-xl font-extrabold">Editar produto</h2>
              <button
                className="icon-button"
                type="button"
            ...
            >
              ...
              <label className="grid gap-1 text-sm font-bold">
                ...
                <input
                  className="field"
                  name="variantName"
                  defaultValue={product.rawPresentation}
                />
              </label>
              <label className="grid gap-1 text-sm font-bold">
                Marca
              ...
              <label className="grid gap-1 text-sm font-bold">
                ...
                <input
                  ...
                  name="cost"
                  inputMode="decimal"
                  defaultValue={product.costValue}
                />
              </label>
              <label className="grid gap-1 text-sm font-bold">
                Preço de venda
              ...
              <label className="grid gap-1 text-sm font-bold">
                ...
                <input
                  ...
                  inputMode="decimal"
                  defaultValue={product.minimumValue}
                />
              </label>
              <label className="grid gap-1 text-sm font-bold">
                SKU
  ...
  return (
    <section className="panel mt-5">
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-3">
        ...
        >
          <option value="all">Todos no estoque</option>
          <option value="stock">Com saldo disponível</option>
          <option value="low">Abaixo do estoque mínimo</option>
        </select>
        <select
          className="field"
          value={categoryId}
        ...
        <table className="w-full min-w-[1100px] text-left text-sm">
          <thead className="border-b text-xs uppercase text-muted">
            <tr>
              ...
              <th className="p-3">Apresentação</th>
              ...
              <th className="p-3 text-right">Venda total</th>
              {canManage && (
                <th className="p-3">
