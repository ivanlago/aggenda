...
export default function TermsPage() {
  return <main className="min-h-screen px-6 py-12"><article className="panel mx-auto max-w-3xl">
    ...
    <div className="mt-8 grid gap-6 leading-7 text-muted">
      ...
      <p>A ativação guiada padrão não possui taxa obrigatória. Implantação assistida e configuração fiscal assistida são serviços opcionais, cobrados uma única vez somente após solicitação e ciência do contratante. Certificados, tributos e provedores fiscais externos são de responsabilidade do contratante.</p>
